...
parser.add_argument('--srednia_wag', '-s', help="Srednia rozkladu normalnego dla wag", type=float, default=10, required=False)
parser.add_argument('--srednia_wartosci', '-S', help="Srednia rozkladu normalnego dla wartosci", type=float, default=10, required=False)
parser.add_argument('--wariancja_wag', '-w', help='Wariancja rozkladu normalnego dla wag', type=float, default=2, required=False)
parser.add_argument('--wariancja_wartosci', '-W', help='Wariancja rozkladu normalnego dla wartosci', type=float, default=2, required=False)
parser.add_argument('--nwd', '-n', help="Zadana najwieksza wspolna wielokrotnosc wag", type=int, default=1, required=False)
